...
export function toSystemSchemaJsonSchema(): Record<string, unknown> {
  const schema = z.toJSONSchema(systemSchemaValidator, { target: 'draft-07' });
  ...
  return {
    ...
    description:
      'Declarative C4 diagram schema used by Blueprint CLI and designer. Generated from Zod — do not edit by hand.',
  };
}
